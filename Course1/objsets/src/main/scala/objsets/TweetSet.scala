...
class NonEmpty(elem: Tweet, left: TweetSet, right: TweetSet) extends TweetSet:
  ...
  def mostRetweeted: Tweet =
    ...
    if (!right.isEmpty && mostRetweetedRight.retweets >= elem.retweets) {
      if (!left.isEmpty && mostRetweetedLeft.retweets >= mostRetweetedRight.retweets) {
        mostRetweetedLeft
      } else {
        mostRetweetedRight
      }
    } else if (!left.isEmpty && mostRetweetedLeft.retweets >= elem.retweets) {
      mostRetweetedLeft
    } else {
      elem
    }
